...
We think we can estimate a population parameter of smoking reasonably well from a sample.
...
3. If we have enough sample we we might be able to directly estimate a subnational population -- Region. Direct estimation
...
4. But we can't do direct estimation -- subsetting/subdividing -- when looking at how an outcome is in smaller areas.
